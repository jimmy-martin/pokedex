...
CREATE DATABASE `pokedex` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `pokedex`;
...
INSERT INTO `pokemon` (`id`, `name`, `pv`, `attack`, `defense`, `spe_attack`, `spe_defense`, `speed`, `number`) VALUES
...
CREATE TABLE `pokemon_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`),
  KEY `pokemon_numero` (`pokemon_number`),
